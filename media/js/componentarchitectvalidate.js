/**
 * @version 		$Id: componentarchitectvalidate.js 577 2016-01-04 15:44:19Z BrianWade $
...
window.addEvent('domready', function() {
	...
	document.formvalidator.setHandler('componentgeneratepluginsemailcloak',
		function (value) {
		    regex = /.*/;
		    return regex.test(value);
		});
	document.formvalidator.setHandler('componentgeneratepluginsloadmodule',
		function (value) {
		    regex = /.*/;
		    return regex.test(value);
		});
	...
	document.formvalidator.setHandler('componentobjectgeneratepluginsemailcloak',
		function (value) {
		    regex = /.*/;
		    return regex.test(value);
		});
	document.formvalidator.setHandler('componentobjectgeneratepluginsloadmodule',
		function (value) {
		    regex = /.*/;
		    return regex.test(value);
		});
