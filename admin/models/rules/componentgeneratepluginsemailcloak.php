<?php
/**
 * @version 		$Id: componentgeneratepluginsemailcloak.php 577 2016-01-04 15:44:19Z BrianWade $
...
/**
 * Form Rule class for the Component/Extension - Generate Plugins - Email Cloaking field.
 */
class JFormRulecomponentgeneratepluginsemailcloak extends JFormRule
{
	/**
	...
	public function test(SimpleXMLElement $element, $value, $group = null, JRegistry $input = null, JForm $form = null)
	{
		...
		else
		{
			...
			if ($joomla_parts['generate_plugins'] == '0' AND $value == '1')
			{
				...
				return new JException(JText::_('COM_COMPONENTARCHITECT_COMPONENTS_FIELD_GENERATE_PLUGINS_EMAILCLOAK_ERROR_PLUGINS_NOT_SET'), 1, E_WARNING);
			}
			//[%%END_CUSTOM_CODE%%]		
			return true;
		}
