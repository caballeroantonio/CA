<?php 
/**
 * @version			$Id: searchreplace.php 577 2016-01-04 15:44:19Z BrianWade $
				...
				{ 			
					switch ($file)
					{
						...
						case 'plg_architectcomp_pagebreak':
							...
							break;		
						case 'plg_architectcomp_emailcloak':
							if (JString::substr($this->generation_placeholder,0,7) == 'plugins')
							{
								$this->generation_placeholder = JString::substr($this->generation_placeholder,0,7).'_emailcloak';
							}
							break;	
						case 'plg_architectcomp_loadmodule':
							if (JString::substr($this->generation_placeholder,0,7) == 'plugins')
							{
								$this->generation_placeholder = JString::substr($this->generation_placeholder,0,7).'_loadmodule';
							}
							break;														
