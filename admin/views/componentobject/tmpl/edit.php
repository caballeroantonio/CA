			...
			<div class="row-fluid">
				...
				<div class="span3">
					<fieldset class="form-vertical">
						...
						if ($user->authorise('core.version.note', 'com_componentarchitect') AND $this->item->version AND $params->get('save_history') AND $params->get('componentobject_save_history')) : ?>
