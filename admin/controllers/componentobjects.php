...
class ComponentArchitectControllerComponentObjects extends JControllerAdmin
{
	...
	public function copy()
	{
		...
		else
		{
			...
			// Copy the items.
			if ($new_records = $model->copy($cid))
			{
				$this->setMessage(JText::plural($this->text_prefix . '_N_ITEMS_COPIED', count($new_records)));
			}
			else
			{
	...
	protected function postDeleteHook(JModelLegacy $model, $ids = null)
	{
        ...
        public function export(){
            $model = $this->getModel('Component Objects','ComponentArchitectModel',array('ignore_request' => FALSE));
