...
function getFields(){
    ...
    $field = array(
        ...
        'FIELD_DESCRIPTION' => '[%%FIELD_DESCRIPTION%%]',//[%%FIELD_DESCRIPTION_INI%%]
    ...
    /*
                ...
                FIELD_DB=`` [%%FIELD_DBTYPEANDSIZE%%] [%%FIELD_DBDEFAULT%%] [%%FIELD_DBCOMMENT%%]
	...
	echo $this->form->getInput('contenthistory');
				...
				echo JHtml::_(
					...
					array(
						'title'  => 'titulo',
						'height' => 450,
						'url' => new JUri('index.php?option=[%%com_architectcomp%%]&view=[%%compobject%%]form&layout=edit&layout=edit&tmpl=component&id=1&function=on_collapseModal')
					)
				);
}
